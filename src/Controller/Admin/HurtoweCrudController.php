...
class HurtoweCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            // ...
            ->setPageTitle('new', 'Nowe zamówienie hurtowe')
            ->setPageTitle('index', 'Zamówienia hurtowe')
            ->setPageTitle('edit', 'Edycja zam. hurtowego')
            ->overrideTemplate('crud/new', 'admin/hurtowe/new.html.twig')
            ->overrideTemplate('crud/edit', 'admin/hurtowe/edit.html.twig')
            ->setEntityLabelInPlural('Zamówienia hurtowe')
            ->setEntityLabelInSingular('zamówienie hurtowe')
